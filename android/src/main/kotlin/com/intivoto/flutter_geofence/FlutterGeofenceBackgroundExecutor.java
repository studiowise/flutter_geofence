...
public class FlutterGeofenceBackgroundExecutor implements MethodCallHandler {
    ...
    public static void setCallbackDispatcher(long callbackHandle) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(FlutterGeofenceUtils.SHARED_PREFERENCES_KEY, 0);
    ...
    private void onInitialized() {
        ...
        FlutterGeofenceBackgroundService.onInitialized();
    }
    ...
    public void onMethodCall(MethodCall call, @NonNull Result result) {
        ...
        try {
            if (method.equals("GeofenceBackground#initialized")) {
    ...
    public void executeDartCallbackInBackgroundIsolate(Intent intent, final CountDownLatch latch) {
        ...
        GeoRegion geoRegion =
                intent.getParcelableExtra(FlutterGeofenceUtils.EXTRA_GEO_LOCATION);
        if (geoRegion != null) {
            Map<String, Object> geoRegionMap =
                    FlutterGeofenceUtils.geoRerionToMap(geoRegion);
            ...
            Log.e(TAG, "GeoRegion instance not found in Intent.");
        }
    }
    ...
    private long getUserCallbackHandle() {
        SharedPreferences prefs =
                ContextHolder.getApplicationContext()
                        .getSharedPreferences(FlutterGeofenceUtils.SHARED_PREFERENCES_KEY, 0);
    ...
    private void initializeMethodChannel(BinaryMessenger isolate) {
        ...
        // - "GeofenceBackground#initialized"
        //
